...
function Hero() {
  return (
    <section
      id="home"
      className="relative h-screen w-full flex flex-col justify-center items-center text-black  overflow-hidden"
    >
      {/* 🎨 Stylish Grid Art Overlay */}
      <div className="absolute inset-0 z-0 grid grid-cols-10 grid-rows-5 gap-1 opacity-80 pointer-events-none">
      ...
      <div className="relative z-10 text-center px-4 mt-20 animate-fadeInUp">
        <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6 leading-tight drop-shadow-lg">
          Welcome to <span className="text-amber-500">My Portfolio</span>
        </h1>
        <p className="text-lg md:text-xl mb-8 font-light max-w-xl mx-auto tracking-wide">
